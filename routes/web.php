...
// Apartment CRUD routes - Protected by auth
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('complaints')->name('complaints.')->group(function () {
        ...
        Route::prefix('artisan')->name('artisan.')->group(function () {
            ...
            Route::get('/tasks-market', [App\Http\Controllers\ArtisanTaskController::class , 'market'])->name('market');
...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/properties/bulk-action', [App\Http\Controllers\Admin\AdminController::class , 'bulkPropertyAction'])->name('properties.bulk-action');
...
Route::prefix('benefactor')->name('benefactor.')->group(function () {
    ...
    // Accept both GET and POST for Paystack callback compatibility
