...
-- Key fixes:
-- 1. Fixed duplicate primary keys in apartment_types and property_types
-- 2. Fixed foreign key reference from apartments to properties
-- 3. Fixed AUTO_INCREMENT issues
