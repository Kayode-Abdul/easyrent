    ...
    <div class="register-container">
        <div class="register-wrapper">
            ...
            <div class="form-container">
                ...
                <form method="post" action="/register" id="registration-Form" class="enhanced-register-form"
                    ...
                    <div class="form-step active" data-step="1">
                        ...
                        <div class="photo-upload">
                            <div class="photo-preview">
                                <img id="photo-preview-img" src="/assets/images/default-avatar.png"
                                    alt="Profile Preview">
                        ...
                        <div class="form-row">
                            <div class="input-group half">
                                <div class="input-wrapper">
                                    <i class="fa fa-user input-icon"></i>
                                    <input type="text" name="f_name" id="f-name" class="form-input"
                            ...
                            <div class="input-group half">
                                <div class="input-wrapper">
                                    <i class="fa fa-user input-icon"></i>
                                    <input type="text" name="l_name" id="l-name" class="form-input"
                            ...
                            <div class="input-group">
                                <div class="input-wrapper">
                                    ...
                                    <select name="role" id="user-role" class="form-select" required>
                                        ...
                                        @php
                                        $publicRoles = \DB::table('roles')->whereIn('name', ['tenant', 'landlord',
                                        'marketer', 'Artisan', 'property_manager'])->get();
                                        @endphp
                                        @foreach($publicRoles as $role)
                                        <option value="{{ $role->id }}">{{ ucfirst($role->display_name ?? $role->name)
                                            }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-row">
                            <div class="input-group">
                                <label class="checkbox-wrapper">
                                    <input type="checkbox" name="is_artisan" id="is-artisan-checkbox"
                                        onchange="toggleArtisanFields()">
                            ...
                            <div class="form-row">
                                <div class="input-group">
                                    <div class="input-wrapper">
                                        ...
                                        <textarea name="artisan_bio" id="artisan-bio" class="form-textarea"
                                            placeholder="Brief bio/description of your services" rows="2"></textarea>
                        ...
                        <div class="form-step" data-step="2">
                            ...
                            <div class="form-row">
                                <div class="input-group">
                                    <div class="input-wrapper">
                                        <i class="fa fa-lock input-icon"></i>
                                        <input type="password" name="repassword" id="repassword" class="form-input"
                                            placeholder="Confirm Password" required>
                                        <label class="floating-label">Confirm Password</label>
                                        <button type="button" class="password-toggle"
                                            onclick="togglePasswordField('repassword')">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="input-group">
                                    <div class="input-wrapper">
                                        ...
                                        <select name="state" id="states" class="form-select" onchange="getCities()"
                                            required>
