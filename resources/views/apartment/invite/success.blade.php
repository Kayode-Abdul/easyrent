                    ...
                    <div class="card-body p-4">
                        <div class="text-center mb-4">
                            <h4 class="text-success mb-3">
                                <i class="fa fa-home me-2"></i>Welcome to Your New Home!
                            </h4>
                            <p class="lead text-muted">
                                Congratulations! Your payment has been processed successfully and your apartment has been
                                assigned to you.
                            </p>
                        </div>
                        ...
                        <div class="row mb-4">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6 class="card-title text-primary">
                                            <i class="fa fa-building me-2"></i>Property Details
                                        </h6>
                                        <ul class="list-unstyled mb-0">
                                            <li><strong>Property:</strong> {{ $invitation->apartment->property->prop_name }}
                                            </li>
                            ...
                            <div class="col-md-6">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6 class="card-title text-primary">
                                            <i class="fa fa-calendar-alt me-2"></i>Lease Information
                                        </h6>
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li><strong>Move-in Date:</strong>
                                                {{ \Carbon\Carbon::parse($invitation->move_in_date)->format('M d, Y') }}
                                            </li>
                        ...
                        <div class="card border-primary mb-4">
                            <div class="card-header bg-primary text-white">
                                <h6 class="mb-0">
                                    <i class="fa fa-user-tie me-2"></i>Your Landlord
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="mb-1"><strong>Name:</strong> {{ $invitation->landlord->first_name }}
                                            {{ $invitation->landlord->last_name }}</p>
                                        <p class="mb-1"><strong>Email:</strong>
                                            <a href="mailto:{{ $invitation->landlord->email }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-0"><strong>Status:</strong> <span class="badge bg-success">Active
                                                Landlord</span></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card border-info mb-4">
                            <div class="card-header bg-info text-white">
                                <h6 class="mb-0">
                                    <i class="fa fa-list-check me-2"></i>Next Steps
                                </h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><i class="fa fa-check text-success me-2"></i>Contact your landlord to
                                                arrange key collection</li>
                                            <li><i class="fa fa-check text-success me-2"></i>Schedule a property inspection
                                            </li>
                                            <li><i class="fa fa-check text-success me-2"></i>Arrange utility connections (if
                                                needed)</li>
                                            <li><i class="fa fa-check text-success me-2"></i>Plan your moving logistics</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <h6 class="text-info">Important Reminders:</h6>
                                        <ul class="list-unstyled">
                                            <li><i class="fa fa-info-circle text-info me-2"></i>Keep your payment receipt
                                                safe</li>
                                            <li><i class="fa fa-info-circle text-info me-2"></i>Review your lease agreement
                                            </li>
                                            <li><i class="fa fa-info-circle text-info me-2"></i>Note your lease end date
                                            </li>
                                            <li><i class="fa fa-info-circle text-info me-2"></i>Save landlord contact
                                                information</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <a href="mailto:{{ $invitation->landlord->email }}"
                                    ...
                                    <i class="fa fa-envelope me-2"></i>Contact Landlord
                                </a>
                            </div>
                            <div class="col-md-4 mb-3">
                ...
                <div class="alert alert-info">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0">
                                Confirmation emails have been sent to both you and your landlord with all the details of
                                this transaction.
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                ...
                                <p class="mb-1">
                                    ...
                                    <a href="mailto:support@easyrent.com"
                                        class="text-decoration-none">support@easyrent.com</a>
                                </p>
                                <p class="mb-0">
