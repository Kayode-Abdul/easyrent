            ...
            <div class="col-lg-6 col-md-8">
                <div class="error-card card shadow-lg border-0">
                    <div class="card-body text-center py-5">
                        <div class="mb-4">
                            <i class="fa fa-search fa-4x error-icon mb-3"></i>
                        ...
                        <div class="reasons-list mb-4 text-start">
                            <h6 class="text-warning mb-3">
                                <i class="fa fa-exclamation-triangle me-2"></i>Possible Reasons
                            </h6>
                            <ul class="list-unstyled">
                                <li>
                                    <i class="fa fa-link me-2 text-warning"></i>
                                    The invitation link is invalid or corrupted
                                </li>
                                <li>
                                    <i class="fa fa-trash me-2 text-warning"></i>
                                    The invitation has been removed by the landlord
                                </li>
                                <li>
                                    <i class="fa fa-home me-2 text-warning"></i>
                        ...
                        <div class="suggestions-card mb-4 text-start">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="mb-0">
                                    <i class="fa fa-headset me-2 text-info"></i>
                        ...
                        <div class="d-grid gap-3">
                            ...
                            <a href="{{ route('login') }}" class="btn btn-outline-secondary btn-modern">
                                <i class="fa fa-sign-in-alt me-2"></i>Login to Existing Account
                            </a>
                        </div>
                        ...
                        <div class="mt-4 pt-4 border-top">
                            <h6 class="text-muted mb-3">
                                <i class="fa fa-question-circle me-2"></i>Still Need Help?
                            </h6>
