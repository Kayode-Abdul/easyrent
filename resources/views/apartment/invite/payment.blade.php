                                ...
                                <div class="col-md-6">
                                    <div class="card border-secondary bg-warning payment-method-card" data-method="flutterwave"
                                        ...
                                        <div class="card-body text-center p-4">
                                            ...
                                            <div class="form-check d-flex justify-content-center">
                                                <input class="form-check-input" type="radio" name="payment_method"
                                                    id="flutterwave_gateway" value="flutterwave">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <label class="form-check-label ms-3" for="terms_agreement">
                                    ...
                                    <div class="small">
                                        I agree to the <a href="#" class="text-decoration-none fw-semibold">Terms and
                                            Conditions</a> and understand that this payment secures my apartment rental for
                                        the specified duration. This transaction is protected by bank-level security.
                                    </div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="mb-1"><i class="fa fa-envelope me-2"></i>support@easyrent.com</p>
                                <p class="mb-0"><i class="fa fa-phone me-2"></i>+234 800 EASYRENT</p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-1"><strong>Landlord Contact:</strong></p>
                                <p class="mb-1"><i class="fa fa-envelope me-2"></i>{{ $invitation->landlord->email }}</p>
                                <p class="mb-0"><i class="fa fa-phone me-2"></i>{{ $invitation->landlord->phone }}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function initiatePayment() {
            ...
            if (gateway === 'paystack') {
                ...
                payWithFlutterwave(gateway);
            }
        }

        function payWithFlutterwave(gatewayMethod) {
            ...
            paymentBtn.innerHTML = '<i class="fa fa-spinner fa-spin me-2"></i>Processing Payment...';
            paymentBtn.disabled = true;
            hidePaymentError();

            try {
                const newReference = generateReference().replace('easyrent_', 'FLW-easyrent_');
                ...
                if (window.calculatedPaymentAmount && window.calculationDetails) {
                    amount = window.calculatedPaymentAmount;
                } else {
                    amount = @json($invitation->total_amount);
                }
                ...
                FlutterwaveCheckout({
                    ...
                    customizations: {
                        ...
                        description: "Apartment Invitation Payment",
        ...
        function showPaymentError(message) {
            ...
            if (!errorAlert) {
                ...
                errorAlert.innerHTML = '<i class="fa fa-exclamation-triangle me-2"></i><span id="payment-error-message"></span>';
        ...
        function showPaymentSuccess(message) {
            ...
            if (!successAlert) {
                ...
                successAlert.innerHTML = '<i class="fa fa-check-circle me-2"></i><span id="payment-success-message"></span>';
        ...
        function showPaymentInfo(message) {
            ...
            if (!infoAlert) {
                ...
                infoAlert.innerHTML = '<i class="fa fa-info-circle me-2"></i><span id="payment-info-message"></span>';
        ...
        function resetPaymentButton(paymentBtn) {
            ...
            paymentBtn.innerHTML = '<i class="fa fa-lock me-2"></i>Pay <span id="btn_total_amount_wrapper">' + currencySymbol + '<span id="btn_total_amount">{{ number_format($invitation->total_amount) }}</span></span> Securely';
        }
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function calculateRentalPayment() {
                ...
                // Show loading state
                calculateBtn.innerHTML = '<i class="fa fa-spinner fa-spin me-2"></i>Calculating...';
                ...
                fetch('/api/payment/calculate-rental', {
                    ...
                    .finally(() => {
                        // Reset button state
                        calculateBtn.innerHTML = '<i class="fa fa-calculator me-2"></i>Calculate Total';
                        calculateBtn.disabled = false;
                    });
            }
            ...
            `;
                ...
                const paymentBtn = document.getElementById('proceedPaymentBtn');
                paymentBtn.innerHTML = `<i class="fa fa-lock me-2"></i>Pay ${calculation.formatted_amount} Securely`;
            ...
            function showCalculationError(message) {
                ...
                if (!errorAlert) {
                    ...
                    errorAlert.className = 'alert alert-danger mt-3';
                    errorAlert.innerHTML = '<i class="fa fa-exclamation-triangle me-2"></i><span id="calculation-error-message"></span>';
