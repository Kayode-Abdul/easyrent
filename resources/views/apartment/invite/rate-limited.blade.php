            ...
            <div class="col-lg-6 col-md-8">
                <div class="rate-limit-card card shadow-lg border-0">
                    <div class="card-body text-center py-5">
                        <div class="mb-4">
                            <i class="fa fa-hourglass-half fa-4x rate-limit-icon mb-3"></i>
                        ...
                        <div class="rate-limit-notice mb-4 text-start">
                            <h6 class="text-warning mb-3">
                                <i class="fa fa-info-circle me-2"></i>Rate Limit Active
                            </h6>
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="mb-0">
                                    <i class="fa fa-refresh me-2 text-warning"></i>
                        ...
                        <div class="rate-limit-tips mb-4 text-start">
                            <h6 class="text-info mb-3">
                                <i class="fa fa-lightbulb me-2"></i>While You Wait
                            </h6>
                            <ul class="list-unstyled mb-0">
                                <li class="mb-2">
                                ...
                                <li class="mb-2">
                                    <i class="fa fa-user-plus me-2 text-info"></i>
                                    Create an account for faster access
                                </li>
                                <li class="mb-2">
                                    <i class="fa fa-bookmark me-2 text-info"></i>
                        ...
                        <div class="d-grid gap-3">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <button onclick="location.reload()" class="btn btn-warning btn-modern w-100"
                                        id="retryBtn" disabled>
                                        <i class="fa fa-sync-alt me-2"></i>Try Again (<span id="retryCountdown">60</span>s)
                                    </button>
                                </div>
                            </div>

                            <a href="{{ route('register') }}" class="btn btn-outline-success btn-modern">
                                <i class="fa fa-user-plus me-2"></i>Create Account for Faster Access
                            </a>
                        </div>
    ...
    <script>
        ...
        function updateCountdown() {
            ...
            if (timeLeft > 0) {
                ...
                retryBtn.innerHTML = '<i class="fa fa-sync-alt me-2"></i>Try Again Now';
