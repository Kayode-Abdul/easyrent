            ...
            <div class="col-lg-6 col-md-8">
                <div class="security-card card shadow-lg border-0">
                    <div class="card-body text-center py-5">
                        <div class="mb-4">
                            <i class="fa fa-shield-alt fa-4x security-icon mb-3"></i>
                            <h2 class="text-danger mb-3 fw-bold">Access Temporarily Blocked</h2>
                            <p class="text-muted mb-4 lead">
                                This invitation has been temporarily blocked due to suspicious activity detected from your
                                location.
                            </p>
                        </div>
                        ...
                        <div class="security-notice mb-4 text-start">
                            <h6 class="text-danger mb-3">
                                <i class="fa fa-exclamation-triangle me-2"></i>Security Alert
                            </h6>
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="mb-0">
                                    <i class="fa fa-lock me-2 text-danger"></i>
                        ...
                        <div class="countdown-timer mb-4 text-center">
                            <div class="text-warning mb-2">
                                <i class="fa fa-hourglass-half me-2"></i>Access will be restored in:
                            </div>
                        ...
                        <div class="security-steps mb-4 text-start">
                            <h6 class="text-info mb-3">
                                <i class="fa fa-lightbulb me-2"></i>What You Can Do
                            </h6>
                            <ol class="mb-0">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <a href="{{ url('/') }}" class="btn btn-primary btn-modern w-100">
                                        <i class="fa fa-home me-2"></i>Browse Properties
                                    </a>
                                </div>
                                <div class="col-md-6 mb-2">
                                    <a href="mailto:support@easyrent.com?subject=Security Block Appeal&body=I believe my access has been incorrectly blocked. Please review my case."
                                        ...
                                        <i class="fa fa-envelope me-2"></i>Appeal Block
                                    </a>
                                </div>
                            </div>

                            <button onclick="location.reload()" class="btn btn-outline-secondary btn-modern">
                                <i class="fa fa-sync-alt me-2"></i>Check Status Again
                            </button>
                        </div>
                        ...
                        <div class="mt-4 pt-4 border-top">
                            <h6 class="text-muted mb-3">
                                <i class="fa fa-question-circle me-2"></i>Need Immediate Help?
                            </h6>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <p class="small mb-1">
                                        ...
                                        <a href="mailto:security@easyrent.com"
                                            class="text-decoration-none">security@easyrent.com</a>
                                    </p>
                                    <p class="small mb-0">
        ...
        function updateCountdown() {
            ...
            if (timeLeft > 0) {
                ...
                document.getElementById('countdown').parentElement.innerHTML =
                    '<div class="text-success"><i class="fa fa-check-circle me-2"></i>You can now try accessing the invitation again</div>';
            }
        }
