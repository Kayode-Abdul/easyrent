            ...
            <div class="col-lg-8">
                    ...
                    @else
                        <div class="card">
                            <div class="card-body text-center">
                                <i class="fa fa-home fa-5x text-primary mb-3"></i>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h3 class="mb-0">
                            <i class="fa fa-home me-2"></i>{{ $property->prop_name }}
                        </h3>
                        <p class="mb-0 opacity-75">
                            <i class="fa fa-map-marker-alt me-1"></i>{{ $property->prop_address }}
                        </p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h5 class="text-primary">
                                    <i class="fa fa-info-circle me-2"></i>Apartment Details
                                </h5>
                            ...
                            <div class="col-md-6">
                                <h5 class="text-primary">
                                    <i class="fa fa-user-tie me-2"></i>Landlord Information
                                </h5>
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <ul class="list-unstyled mb-0">
                                            <li class="mb-2">
                                                <strong>Name:</strong> {{ $landlord->first_name }}
                                                {{ $landlord->last_name }}
                                            </li>
                                            <li class="mb-2">
                                                <strong>Email:</strong>
                        ...
                        @if($property->prop_description)
                            <div class="mt-4">
                                <h5 class="text-primary">
                                    <i class="fa fa-file-alt me-2"></i>Property Description
                                </h5>
                        ...
                        @if($property->amenities && $property->amenities->count() > 0)
                            <div class="mt-4">
                                <h5 class="text-primary">
                                    <i class="fa fa-star me-2"></i>Amenities & Features
                                </h5>
                                <div class="row">
                                    @foreach($property->amenities as $amenity)
                                        <div class="col-md-6 mb-2">
                                            <span class="badge bg-light text-dark border">
                                                <i class="fa fa-check-circle text-success me-1"></i>{{ $amenity->name }}
                                            </span>
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="mt-4">
                            <h5 class="text-primary">
                                <i class="fa fa-map-marker-alt me-2"></i>Location Details
                            </h5>
                            <div class="row">
                                <div class="col-md-6">
                                    <ul class="list-unstyled">
            ...
            <div class="col-lg-4">
                ...
                <div class="card sticky-top shadow">
                    <div class="card-header bg-success text-white">
                        <h5 class="mb-0">
                            <i class="fa fa-key me-2"></i>Apply for this Apartment
                        </h5>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                        ...
                        @auth
                            ...
                            <form action="{{ route('apartment.invite.apply', $invitation->invitation_token) }}"
                                method="POST" id="applicationForm">
                                @csrf

                                <div class="mb-3">
                                    <label class="form-label fw-semibold">
                                        <i class="fa fa-calendar me-1 text-primary"></i>Lease Duration *
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">
                                        <i class="fa fa-calendar-check me-1 text-primary"></i>Preferred Move-in Date *
                                    </label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">
                                        <i class="fa fa-comment me-1 text-primary"></i>Additional Notes (Optional)
                                    </label>
                                ...
                                <div class="total-calculation mb-4" data-apartment-amount="{{ $apartment->amount }}"
                                    data-pricing-type="{{ $proformaData['pricing_type'] ?? 'total' }}">
                                    <div class="card bg-gradient payment-summary-card"
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if(isset($proformaData['pricing_type']) && $proformaData['pricing_type'] === 'monthly')
                                                <div class="calculation-breakdown mt-2 p-2"
                                            ...
                                            <!-- Error display area -->
                                            <div id="calculation-error" class="alert alert-warning mt-2"
                                                style="display: none;">
                                ...
                                <div class="alert alert-info border-0"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="small">By applying, you agree to proceed with secure payment to
                                                reserve this apartment.</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button type="submit" class="btn btn-success btn-lg w-100 py-3"
                                    ...
                                    <i class="fa fa-credit-card me-2"></i>Proceed to Secure Payment
                                </button>
                            </form>
                        @else
                            <!-- Unauthenticated User - Must Login/Signup First -->
                            <div class="unauthenticated-application">
                                <!-- Pay Now Button (Initial State) -->
                                <div id="payNowSection">
                                    <div class="mb-4 text-center">
                                        <div class="mb-3"
                                            style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 50%; width: 80px; height: 80px; display: flex; align-items: center; justify-content: center; margin: 0 auto;">
                                            <i class="fa fa-credit-card fa-2x text-success"></i>
                                        </div>
                                        <h6 class="text-success fw-semibold">Ready to Secure this Apartment?</h6>
                                        <p class="small text-muted mb-0">
                                            Follow the link, click the button below to proceed with your payment.
                                        </p>
                                    </div>
                                    <button type="button" class="btn btn-success btn-lg w-100 py-3" id="showAuthBtn" style="border-radius: 12px; font-weight: 600;">
                                        <i class="fa fa-credit-card me-2"></i>Pay Now
                                    </button>
                                </div>

                                <!-- Authentication Options (Hidden by Default) -->
                                <div id="authOptionsSection" style="display: none;">
                                    <div class="mb-4 text-center">
                                        <div class="mb-3"
                                            style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 50%; width: 80px; height: 80px; display: flex; align-items: center; justify-content: center; margin: 0 auto;">
                                            <i class="fa fa-user-lock fa-2x text-primary"></i>
                                        </div>
                                        <h6 class="text-primary fw-semibold">Please login or register to proceed with your payment</h6>
                                        <p class="small text-muted mb-0">
                                            Secure your identity to complete the transaction safely.
                                        </p>
                                    </div>

                                    <!-- Authentication Buttons -->
                                    <div class="d-grid gap-3 mb-4">
                                        <a href="{{ route('login', ['invitation_token' => $invitation->invitation_token]) }}"
                                            class="btn btn-primary btn-lg py-3" style="border-radius: 12px; font-weight: 600;">
                                            <i class="fa fa-sign-in-alt me-2"></i>Log In
                                        </a>
                                        <a href="{{ route('register', ['invitation_token' => $invitation->invitation_token]) }}"
                                            class="btn btn-success btn-lg py-3" style="border-radius: 12px; font-weight: 600;">
                                    ...
                                    <div class="alert alert-info border-0"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="small">Your account helps us process your payment securely and
                                                    manage your apartment details.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        if (showAuthBtn) {
                                            showAuthBtn.addEventListener('click', function() {
                                                ...
                                                document.getElementById('authOptionsSection').style.display = 'block';
                                            });
                                        }
                                    });
                                </script>
                                ...
                                <div class="card bg-light mt-4">
                                    <div class="card-body">
                                        <h6 class="card-title text-primary mb-3">
                                            <i class="fa fa-home me-2"></i>Property Summary
                                        </h6>
                                        <div class="d-flex justify-content-between mb-2">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <h6 class="card-title">
                            <i class="fa fa-shield-alt me-2 text-success"></i>Secure & Protected
                        </h6>
                        <ul class="list-unstyled small text-muted mb-0">
                            <li><i class="fa fa-check text-success me-2"></i>SSL encrypted payments</li>
                            <li><i class="fa fa-check text-success me-2"></i>Verified landlord</li>
                            <li><i class="fa fa-check text-success me-2"></i>24/7 support available</li>
                        </ul>
                    </div>
                </div>
            </div>
