                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('marketer.campaigns.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="target_audience">Primary Target <span
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="alert alert-info">
                                        <h6><i class="fa fa-info-circle"></i> Your Referral Information</h6>
                                        <p><strong>Your Referral Code:</strong>
                                            <code>{{ auth()->user()->referral_code }}</code></p>
                                        <p><strong>Commission Rate:</strong> {{ auth()->user()->commission_rate }}% per
                                            successful referral</p>
                                        <p class="mb-0"><strong>Referral Link Preview:</strong>
                                            <span
                                                id="linkPreview">{{ url('/register?ref=' . auth()->user()->referral_code . '&campaign=') }}[CAMPAIGN-CODE]</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" id="qrInfo" style="display: none;">
                                <div class="col-md-12">
                                    <div class="alert alert-success">
                                        <h6><i class="fa fa-qrcode"></i> QR Code Features</h6>
                                        <ul class="mb-0">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fa fa-rocket"></i> Create Campaign
                                        </button>
                                    </div>
                                </div>
                            </div>
