                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('target_market') is-invalid @enderror"
                                            ...
                                            <option value="property_managers" {{ old('target_market', $profile->target_market ?? '') === 'property_managers' ? 'selected' : '' }}>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="channel_{{ $channel }}" {{ in_array($channel, $selectedChannels) ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file"
                                                class="form-control-file @error('id_document') is-invalid @enderror"
                                                id="id_document" name="id_document" accept=".pdf,.jpg,.jpeg,.png">
                                            <small class="form-text text-muted">Upload your national ID, passport, or driver's
                                                license</small>
                                            @error('id_document')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file"
                                                class="form-control-file @error('business_permit') is-invalid @enderror"
                                                id="business_permit" name="business_permit" accept=".pdf,.jpg,.jpeg,.png">
                                            <small class="form-text text-muted">Upload your business permit or
                                                certificate</small>
