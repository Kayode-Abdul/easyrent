                    ...
                    <div class="card-body">
                        ...
                        <div class="progress mb-3" style="height: 5px">
                            <div class="progress-bar bg-primary" role="progressbar"
                                style="width: {{ auth()->user()->commission_rate * 10 }}%"
                                aria-valuenow="{{ auth()->user()->commission_rate }}" aria-valuemin="0" aria-valuemax="10">
                            </div>
                        </div>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        @else
                            <a href="{{ route('marketer.profile.create') }}" class="btn btn-success">
                                <i class="fa fa-plus"></i> Complete Profile
                            </a>
                        @endif
                    </div>
                    <div class="card-body">
                                            ...
                                            <td>
                                                @if($profile->marketing_channels)
                                                    @foreach(json_decode($profile->marketing_channels) as $channel)
                                                        <span
                                                            class="badge badge-info mr-1">{{ ucfirst(str_replace('_', ' ', $channel)) }}</span>
                                                    @endforeach
                                                @endif
                                            </td>
                                        </tr>
