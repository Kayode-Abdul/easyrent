                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('marketer.profile.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('business_type') is-invalid @enderror"
                                            ...
                                            <option value="individual_marketer" {{ old('business_type') == 'individual_marketer' ? 'selected' : '' }}>Individual
                                                Marketer</option>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="preferred_commission_rate" class="form-label">Preferred Commission Rate
                                            (%) <span class="text-danger">*</span></label>
                                        <input type="number"
                                            class="form-control @error('preferred_commission_rate') is-invalid @enderror"
                                            id="preferred_commission_rate" name="preferred_commission_rate"
                                            value="{{ old('preferred_commission_rate', '5') }}" min="1" max="15" step="0.5"
                                            required>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <h6 class="text-primary border-bottom pb-2 mb-3">
                                        <i class="fa fa-bullhorn me-2"></i>Marketing Information
                                    </h6>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label for="marketing_channels" class="form-label">Marketing Channels <span
                                                class="text-danger">*</span></label>
                                        <textarea class="form-control @error('marketing_channels') is-invalid @enderror"
                                            id="marketing_channels" name="marketing_channels" rows="3"
                                            required>{{ old('marketing_channels') }}</textarea>
                                        <div class="form-text">Describe your marketing channels (e.g., Social Media,
                                            WhatsApp Groups, Email Marketing, etc.)</div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label for="target_regions" class="form-label">Target Regions <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('bio') is-invalid @enderror" id="bio"
                                            name="bio" rows="4" maxlength="1000">{{ old('bio') }}</textarea>
                                        <div class="form-text">Tell us about your marketing experience and expertise
                                            (optional)</div>
                                        @error('bio')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('social_media_handles') is-invalid @enderror"
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <h6 class="text-primary border-bottom pb-2 mb-3">
                                        <i class="fa fa-file-upload me-2"></i>KYC Documents <span
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="kyc_document_id" class="form-label">Valid ID Document <span
                                                class="text-danger">*</span></label>
                                        <input type="file"
                                            class="form-control @error('kyc_documents.id') is-invalid @enderror"
                                            id="kyc_document_id" name="kyc_documents[id]" accept=".pdf,.jpg,.jpeg,.png"
                                            required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="kyc_document_address" class="form-label">Proof of Address <span
                                                class="text-danger">*</span></label>
                                        <input type="file"
                                            class="form-control @error('kyc_documents.address') is-invalid @enderror"
                                            id="kyc_document_address" name="kyc_documents[address]"
                                            accept=".pdf,.jpg,.jpeg,.png" required>
                                        <div class="form-text">Upload utility bill or bank statement (not older than 3
                                            months)</div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="file"
                                            class="form-control @error('kyc_documents.business') is-invalid @enderror"
                                            id="kyc_document_business" name="kyc_documents[business]"
                                            accept=".pdf,.jpg,.jpeg,.png">
                                        <div class="form-text">Upload CAC certificate or business registration (if
                                            applicable)</div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="file"
                                            class="form-control @error('kyc_documents.tax') is-invalid @enderror"
                                            id="kyc_document_tax" name="kyc_documents[tax]" accept=".pdf,.jpg,.jpeg,.png">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="terms-content" style="max-height: 400px; overflow-y: auto;">
                        ...
                        <p>The EasyRent Marketer Program allows qualified individuals and businesses to earn commissions by
                            referring landlords to our platform.</p>
                        ...
                        <h6>6. Termination</h6>
                        <p>EasyRent reserves the right to terminate marketer accounts for violation of these terms or at its
                            sole discretion.</p>
                    </div>
                </div>
