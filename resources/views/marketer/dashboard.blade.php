                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="text-muted mb-0">Welcome back, {{ $marketer->first_name }}! Track your referrals
                                    and earnings.</p>
                            </div>
                            <div>
                                ...
                                @elseif($marketer->marketer_status === 'active')
                                    <span class="badge bg-success fs-6">
                                        <i class="fa fa-check-circle"></i> Active Marketer
                                    </span>
                                @else
                                    <span class="badge bg-danger fs-6">
                                        <i class="fa fa-times-circle"></i> {{ ucfirst($marketer->marketer_status) }}
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="alert alert-info">
                        ...
                        @if(!$profile)
                            <a href="{{ route('marketer.profile.create') }}" class="alert-link">Complete your profile</a> to speed
                            up the process.
                        @endif
                    </div>
                </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header bg-light">
                        <h6 class="mb-0">
                            <i class="fa fa-mouse-pointer text-info me-2"></i>
                            Total Clicks
                        </h6>
                    </div>
                    <div class="card-body text-center">
                                        ...
                                        <div class="card border-info">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <div>
                                                        <h6 class="mb-1">{{ $referringSuperMarketer->first_name }}
                                                            {{ $referringSuperMarketer->last_name }}</h6>
                                                ...
                                                @if($referringSuperMarketer->marketerProfile)
                                                    <div class="small text-muted">
                                                        <div><strong>Business:</strong>
                                                            {{ $referringSuperMarketer->marketerProfile->business_name }}</div>
                                                        <div><strong>Experience:</strong>
                                                            {{ $referringSuperMarketer->marketerProfile->years_of_experience }} years
                                                        </div>
                                                    </div>
                                                @endif
                                                <button class="btn btn-sm btn-outline-info mt-2"
                                                    onclick="viewSuperMarketerDetails()">
                                ...
                                <div class="col-md-6">
                                    <div class="card border-success">
                                        <div class="card-header bg-success text-white">
                                            <h6 class="mb-0">
                                                <i class="fa fa-chart-network me-2"></i>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <button class="btn btn-sm btn-outline-success mt-2" onclick="viewFullChain()">
                                                <i class="fa fa-expand me-1"></i>View Full Chain
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                            ...
                                            <div
                                                ...
                                                <span class="fw-medium">
                                                    @if($tier === 'super_marketer_rate')
                                                        <i class="fa fa-user-tie text-info me-2"></i>Super Marketer
                                                    @elseif($tier === 'marketer_rate')
                                                        <i class="fa fa-user text-success me-2"></i>Marketer (You)
                                                    @elseif($tier === 'regional_manager_rate')
                                                        <i class="fa fa-user-cog text-primary me-2"></i>Regional Manager
                                                    @else
                                                        <i
                                                            class="fa fa-building text-secondary me-2"></i>{{ ucfirst(str_replace('_', ' ', $tier)) }}
                                                    @endif
                                                </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="recentCommissions">
                                                ...
                                                <div class="text-end">
                                                    @if($payment->commission_tier)
                                                        <div class="badge bg-info mb-1">
                                                            {{ ucfirst(str_replace('_', ' ', $payment->commission_tier)) }}</div>
                                                    @endif
                                                    <div>
                                    ...
                                    @else
                                        <div class="text-muted text-center py-3">
                                            <i class="fa fa-credit-card fa-2x mb-2 d-block opacity-25"></i>
                    ...
                    <div class="card-body p-0">
                            ...
                            <div class="list-group list-group-flush">
                                @foreach($recentReferrals->take(5) as $referral)
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6 class="mb-1">{{ $referral->referred->first_name }}
                                                {{ $referral->referred->last_name }}</h6>
                                        ...
                                        <div>
                                            ...
                                            @else
                                                <span
                                                    class="badge bg-info">{{ ucfirst($referral->referred->role == 3 ? 'Tenant' : 'User') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        @else
                            <div class="p-4 text-center text-muted">
                                <i class="fa fa-user-plus fa-3x mb-3 d-block opacity-25"></i>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        ...
                        @else
                            <div class="p-4 text-center text-muted">
                                <i class="fa fa-bullhorn fa-3x mb-3 d-block opacity-25"></i>
                                <h6>No Active Campaigns</h6>
                                <p class="small">
                                    <a href="{{ route('marketer.campaigns.create') }}" class="text-decoration-none">Create your
                                        first campaign</a>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group btn-group-sm">
                            <button class="btn btn-outline-secondary active" data-period="30"
                                onclick="loadPerformanceComparison(30)">30d</button>
                            <button class="btn btn-outline-secondary" data-period="90"
                                onclick="loadPerformanceComparison(90)">90d</button>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="{{ route('marketer.campaigns.create') }}" class="btn btn-outline-primary w-100">
                                        <i class="fa fa-plus me-2"></i>Create Campaign
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <button class="btn btn-outline-success w-100" onclick="copyReferralLink()">
                                        <i class="fa fa-copy me-2"></i>Copy Referral Link
                                    </button>
                                </div>
                                <div class="col-md-3">
        ...
        function copyReferralLink() {
            ...
            navigator.clipboard.writeText(referralLink).then(function () {
                ...
                <div class="alert alert-success alert-dismissible fade show position-fixed" style="top: 20px; right: 20px; z-index: 9999;" role="alert">
                    <i class="fa fa-check-circle me-2"></i>Referral link copied to clipboard!
                                ...
                                <div class="modal-content">
                                    <div class="modal-header bg-info text-white">
                                        <h5 class="modal-title">
                                            <i class="fa fa-user-tie me-2"></i>Super Marketer Details
                                        </h5>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header bg-success text-white">
                                        <h5 class="modal-title">
                                            <i class="fa fa-sitemap me-2"></i>Complete Referral Chain
                                        </h5>
                                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                    </div>
                                    <div class="modal-body">
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        const alert = `
                        <div class="alert alert-success alert-dismissible fade show position-fixed" style="top: 20px; right: 20px; z-index: 9999;" role="alert">
                            <i class="fa fa-check-circle me-2"></i>Commission breakdown refreshed!
                            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                        </div>
                    `;
                        $('body').append(alert);
