                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p class="card-title">₦{{ number_format($stats['company_commission_today'] ?? 0, 0) }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p class="card-title">₦{{ number_format($stats['company_commission_this_month'] ?? 0, 0)
                                    }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p class="card-title">₦{{ number_format($stats['company_commission_total'] ?? 0, 0) }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p class="card-title">
                                    @if(isset($stats['commission_breakdown']['this_month']['total_rent']) &&
                                    $stats['commission_breakdown']['this_month']['total_rent'] > 0)
                                    {{ number_format(($stats['commission_breakdown']['this_month']['company_commission']
                                    / $stats['commission_breakdown']['this_month']['total_rent']) * 100, 2) }}%
                                    @else
                                    3.25%
                                    @endif
                                </p>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr class="table-success">
                                            ...
                                            <td>
                                                <span
                                                    class="badge {{ $stats['commission_breakdown']['growth']['company_commission'] >= 0 ? 'bg-success' : 'bg-danger' }}">
                                                    {{
                                                    number_format($stats['commission_breakdown']['growth']['company_commission']
                                                    ?? 0, 1) }}%
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>₦{{
                                                number_format($stats['commission_breakdown']['this_month']['super_marketer_commission']
                                                ?? 0, 0) }}</td>
                                            <td>
                                                @if($stats['commission_breakdown']['this_month']['total_rent'] > 0)
                                                {{
                                        ...
                                        <tr>
                                            ...
                                            <td>₦{{
                                                number_format($stats['commission_breakdown']['this_month']['marketer_commission']
                                                ?? 0, 0) }}</td>
                                            <td>
                                                @if($stats['commission_breakdown']['this_month']['total_rent'] > 0)
                                                {{
                                        ...
                                        <tr>
                                            ...
                                            <td>₦{{
                                                number_format($stats['commission_breakdown']['this_month']['regional_manager_commission']
                                                ?? 0, 0) }}</td>
                                            <td>
                                                @if($stats['commission_breakdown']['this_month']['total_rent'] > 0)
                                                {{
                                    ...
                                    <tfoot class="table-light">
                                        <tr>
                                            ...
                                            <th>₦{{
                                                number_format($stats['commission_breakdown']['this_month']['total_commission']
                                                ?? 0, 0) }}</th>
                                            <th>
                                                @if($stats['commission_breakdown']['this_month']['total_rent'] > 0)
                                                {{
                                            ...
                                            <th>
                                                <span
                                                    class="badge {{ $stats['commission_breakdown']['growth']['total_commission'] >= 0 ? 'bg-success' : 'bg-danger' }}">
                                                    {{
                                                    number_format($stats['commission_breakdown']['growth']['total_commission']
                                                    ?? 0, 1) }}%
                                                </span>
                                            </th>
                                        </tr>
                        ...
                        <div class="col-md-4">
                            <div class="text-center">
                                ...
                                <div class="progress mb-3">
                                    @php
                                    $companyPercentage =
                                    $stats['commission_breakdown']['this_month']['total_commission'] > 0
                                    ? ($stats['commission_breakdown']['this_month']['company_commission'] /
                                    $stats['commission_breakdown']['this_month']['total_commission']) * 100
                                    : 0;
                                    @endphp
