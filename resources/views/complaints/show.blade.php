                                        ...
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            <div class="attachment-item border rounded p-3">
                                                <div class="d-flex align-items-center">
                                                    <i class="{{ $attachment->file_icon }} text-primary mr-2" style="font-size: 1.5rem;"></i>
                            ...
                            <div class="alert alert-success">
                                ...
                                @if($complaint->resolved_by)
                                    <small class="text-muted">
                                        Resolved by {{ $complaint->resolvedBy->first_name }} {{ $complaint->resolvedBy->last_name }}
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="info-item mb-3">
                            ...
                            <div class="mt-1">
                                <i class="{{ $complaint->category->icon }} text-{{ $complaint->category->priority_color }}"></i>
                        ...
                        <div class="info-item mb-3">
                            ...
                            <div class="mt-1">{{ $complaint->tenant->first_name }} {{ $complaint->tenant->last_name }}</div>
                        </div>

                        <div class="info-item mb-3">
                            <strong>Landlord:</strong>
                            <div class="mt-1">{{ $complaint->landlord->first_name }} {{ $complaint->landlord->last_name }}</div>
                        </div>

                        @if($complaint->assigned_to)
                            <div class="info-item mb-3">
                                <strong>Assigned To:</strong>
                                <div class="mt-1">{{ $complaint->assignedTo->first_name }} {{ $complaint->assignedTo->last_name }}</div>
                            </div>
                        @endif
