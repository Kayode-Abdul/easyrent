    ...
    <div class="content pt-3">
        ...
        ? 'selected' : '' }}>In Progress</option>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select name="priority" class="form-control form-select-sm">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select name="category" class="form-control form-select-sm">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select name="sort_by" class="form-control form-select-sm">
