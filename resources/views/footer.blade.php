...
$isDashboard = in_array($currentSegment, ['dashboard', 'admin', 'proforma', 'property-manager', 'complaints', 'artisan']); @endphp
@if($isDashboard)
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
            <h4
              style="color: #ff5e15; font-weight: 600; margin-bottom: 25px; font-size: 1.5rem; position: relative; padding-bottom: 10px;">
              EasyRent
          ...
          <div class="col-lg-2 col-md-6 mb-4 mb-md-0">
            <h4
              style="color: #ff5e15; font-weight: 600; margin-bottom: 25px; font-size: 1.2rem; position: relative; padding-bottom: 10px;">
              Quick Links
              <span style="display: block; width: 50px; height: 3px; background: #ff5e15; margin-top: 10px;"></span>
            </h4>
          ...
          <div class="col-md-6 text-md-left text-center mb-3 mb-md-0">
            <div class="copyright" style="color: #adb5bd;">
              ...
              <script>document.write(new Date().getFullYear())</script> <strong><span
                  style="color: #ff5e15;">EasyRent</span></strong>. All Rights Reserved
            </div>
          </div>
          <div class="col-md-6 text-md-right text-center">
            <div class="credits" style="color: #adb5bd;">
              Designed by <a href="https://wandggroup.com/" style="color: #ff5e15; text-decoration: none;">Walls and
                Gates</a>
            </div>
          </div>
        </div>
