  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card shadow">
        <div class="card-header bg-gradient-primary text-info">
        ...
        <div class="card-body">
            ...
            <table class="table table-hover table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a href="/dashboard/property/{{ $property->property_id }}" class="btn btn-success btn-sm"
                        data-toggle="tooltip" title="View Details">
                        <i class="fa fa-eye"></i>
                      </a>
                      <a href="/dashboard/property/{{ $property->property_id }}/edit"
                        class="btn btn-warning text-info btn-sm" data-toggle="tooltip" title="Edit Property">
                        <i class="fa fa-edit"></i>
                      </a>
                      <button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Delete Property"
          ...
          <div class="d-flex justify-content-between align-items-center mt-4">
            <div>
              <p class="text-muted">Showing {{ $all_properties->firstItem() ?? 0 }} to {{ $all_properties->lastItem() ??
                0 }} of {{ $all_properties->total() ?? 0 }} properties</p>
            </div>
            <div>
