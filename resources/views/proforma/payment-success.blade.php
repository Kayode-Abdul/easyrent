            ...
            <div class="col-md-8">
                ...
                <div class="card border-success shadow-lg">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted mb-4">Your payment has been processed successfully and your apartment has been
                            assigned.</p>
                        ...
                        <div class="alert alert-light border-left border-success" style="border-left-width: 4px;">
                            <div class="row text-left">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <span
                                        class="text-success font-weight-bold">{{ format_money($payment->amount, $payment->currency) }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
