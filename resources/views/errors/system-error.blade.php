                ...
                <div class="card border-warning">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            ...
                            <p class="mb-0 mt-2">
                                {{ $error_message ?? 'Our system is temporarily unavailable. We\'re working to resolve this issue as quickly as possible.' }}
                            </p>
                        </div>
                        ...
                        <div class="mt-4 text-center">
                            ...
                            @if(session('easyrent_invitation_token'))
                                <a href="{{ route('apartment.invite.show', session('easyrent_invitation_token')) }}"
                                    ...
                                    <i class="fa fa-home"></i> Return to Apartment
                                </a>
                            @endif
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <span
                                        class="badge bg-{{ $system_status['database'] === 'connected' ? 'success' : 'danger' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span
                                        class="badge bg-{{ $system_status['services'] === 'operational' ? 'success' : 'warning' }}">
