                ...
                <div class="card border-warning">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            ...
                            <p class="mb-0 mt-2">
                                {{ $error_message ?? 'We encountered an issue with your session data. This may be due to inactivity or a temporary system issue.' }}
                            </p>
                        </div>
                            ...
                            <div class="mt-4">
                                ...
                                @if($recovery_strategy['requires_fresh_start'] ?? false)
                                    <div class="alert alert-warning">
                                        ...
                                        <strong>Fresh Start Required:</strong> You'll need to start over by accessing the apartment
                            ...
                            <div class="list-group">
                                @if(session('preserved_invitation_token'))
                                    <div class="list-group-item">
                                        ...
                                        <p class="mb-1">Use your preserved apartment invitation to continue where you left off.
                                        </p>
                                        <a href="{{ route('apartment.invite.show', session('preserved_invitation_token')) }}"
                                            class="btn btn-success btn-sm">
                                            <i class="fa fa-play"></i> Continue Application
                                        </a>
                                    </div>
                                @endif
                                ...
                                <div class="list-group-item">
                                    ...
                                    <p class="mb-1">Clear all session data and start over with a new apartment invitation
                                        link.</p>
                                ...
                                <div class="list-group-item">
                                    ...
                                    <p class="mb-1">Get help from our support team if you continue experiencing session
                                        issues.</p>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                {{ substr($session_info['session_id'] ?? 'Unknown', 0, 8) }}...
                                            </div>
                                            <div class="col-md-6">
                                                <strong>Last Activity:</strong>
                                                {{ $session_info['last_activity'] ?? 'Unknown' }}
                                            </div>
                                        </div>
