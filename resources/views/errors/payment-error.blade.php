                ...
                <div class="card border-danger">
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning">
                            ...
                            <p class="mb-0 mt-2">
                                {{ $error_message ?? 'We encountered an issue processing your payment. Please try again or use an alternative payment method.' }}
                            </p>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            {{ format_money($payment_details['amount'] ?? 0, ($payment_details['currency'] ?? null)) }}
                                        </div>
                                        <div class="col-md-6">
                        ...
                        @if(isset($recovery_options))
                            <div class="mt-4">
                                ...
                                @if($recovery_options['retry_payment'] ?? false)
                                    <div class="alert alert-info">
                                        ...
                                        @if(isset($recovery_options['retry_delay']))
                                            <br><small>Please wait {{ $recovery_options['retry_delay'] }} seconds before
                                                retrying.</small>
                                        @endif
                                    </div>
                                @endif
                                ...
                                @if($recovery_options['try_different_card'] ?? false)
                                    <div class="alert alert-info">
                                        <i class="fa fa-credit-card"></i>
                                        <strong>Try Different Payment Method:</strong> Consider using a different card or payment
                                        method.
                                    </div>
                                @endif
                                ...
                                @if($recovery_options['contact_bank'] ?? false)
                                    <div class="alert alert-info">
                                        ...
                                        <strong>Contact Your Bank:</strong> Your bank may have declined the transaction. Please
                                ...
                                @if($recovery_options['save_application'] ?? false)
                                    <div class="alert alert-success">
                                        ...
                                        <strong>Application Saved:</strong> Your apartment application has been saved. You can
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">
                                                        <small class="text-muted">Processing Time:
                                                            {{ $details['processing_time'] }}</small>
                                                    </p>
                        ...
                        @if(isset($support_reference))
                            <div class="alert alert-light mt-4">
                                ...
                                <br>
                                <small class="text-muted">Please provide this reference when contacting support about this
                                    payment issue.</small>
                            </div>
                        @endif
                        ...
                        <div class="mt-4 text-center">
                            @if(isset($retry_allowed) && $retry_allowed)
                                <button onclick="retryPayment()" class="btn btn-primary me-2" id="retryBtn">
                                    <i class="fa fa-sync-alt"></i> Retry Payment
                                </button>
                            @endif

                            @if(session('easyrent_invitation_token'))
                                <a href="{{ route('apartment.invite.show', session('easyrent_invitation_token')) }}"
                                    class="btn btn-outline-primary me-2">
                                    <i class="fa fa-arrow-left"></i> Back to Apartment
                                </a>
                            @endif
    ...
    <script>
        function retryPayment() {
            ...
            if (retryBtn) {
                ...
                retryBtn.innerHTML = '<i class="fa fa-spinner fa-spin"></i> Processing...';
        ...
        @if(isset($recovery_options['retry_delay']))
            ...
            if (retryBtn && retryDelay > 0) {
                ...
                const updateButton = () => {
                    if (countdown > 0) {
                        retryBtn.innerHTML = `<i class="fa fa-clock"></i> Retry in ${countdown}s`;
                        countdown--;
                        setTimeout(updateButton, 1000);
                    } else {
                        retryBtn.disabled = false;
                        retryBtn.innerHTML = '<i class="fa fa-sync-alt"></i> Retry Payment';
                    }
                };
