                ...
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="align-self-center">
                                <i class="fa fa-user-clock fa-2x opacity-75"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-info text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="align-self-center">
                                <i class="fa fa-handshake fa-2x opacity-75"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                        <h6 class="mb-0">
                            <i class="fa fa-file-alt text-warning me-2"></i>
                            Recent Applications
                        </h6>
                        <a href="{{ route('admin.marketers.list', ['status' => 'pending']) }}"
                    ...
                    <div class="card-body p-0">
                                    ...
                                    <div class="list-group-item">
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <div class="text-end">
                                                ...
                                                <div class="mt-1">
                                                    <a href="{{ route('admin.marketers.show', $application) }}"
                        ...
                        @else
                            <div class="p-4 text-center text-muted">
                                <i class="fa fa-file-alt fa-3x mb-3 d-block opacity-25"></i>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center">
                                                <div class="me-3">
                                                    @if($index < 3)
                                                        <i
                                                            class="fa fa-medal text-{{ $index == 0 ? 'warning' : ($index == 1 ? 'secondary' : 'dark') }}"></i>
                                                    @else
                        ...
                        @else
                            <div class="p-4 text-center text-muted">
                                <i class="fa fa-trophy fa-3x mb-3 d-block opacity-25"></i>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-light d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.marketers.rewards', ['status' => 'pending']) }}"
                                class="btn btn-sm btn-outline-primary">View All</a>
                        </div>
                        <div class="card-body p-0">
                                    ...
                                    <tbody>
                                        @foreach($pendingRewards->take(10) as $reward)
                                            <tr>
                                                <td>
                                                    <div>
                                                        <strong>{{ $reward->marketer->first_name }}
                                                            {{ $reward->marketer->last_name }}</strong>
                                                        <br><small class="text-muted">{{ $reward->marketer->email }}</small>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div>
                                                        <strong>{{ $reward->referral->referred->first_name ?? 'N/A' }}
                                                            {{ $reward->referral->referred->last_name ?? '' }}</strong>
                                                        <br><small
                                                            class="text-muted">{{ $reward->referral->referred->email ?? 'N/A' }}</small>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <form action="{{ route('admin.marketers.rewards.approve', $reward) }}"
                                                            method="POST" class="d-inline">
                                                            @csrf
                                                            <button type="submit" class="btn btn-outline-success"
                                                                onclick="return confirm('Approve this commission?')">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <a href="{{ route('admin.marketers.list', ['status' => 'pending']) }}"
                                    ...
                                    <i class="fa fa-clock me-2"></i>Review Applications
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('admin.marketers.rewards', ['status' => 'pending']) }}"
                                    class="btn btn-outline-info w-100">
                                    <i class="fa fa-money-bill me-2"></i>Review Commissions
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('admin.marketers.payments') }}" class="btn btn-outline-success w-100">
                                    <i class="fa fa-credit-card me-2"></i>Process Payments
                                </a>
                            </div>
                            <div class="col-md-3">
