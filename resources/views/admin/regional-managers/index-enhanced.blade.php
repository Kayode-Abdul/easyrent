    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="stats-card blue">
                ...
                <div class="stats-value">
                    {{ $regionalManagers->count() > 0 ? number_format($regionalManagers->sum(function($m) { return
                    $m->regionalScopes->count(); }) / $regionalManagers->count(), 1) : 0 }}
                </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="empty-state">
                ...
                <p>{{ $search || $region ? 'Try adjusting your filters' : 'Start by assigning the Regional Manager role
                    to users' }}</p>
                @if($search || $region)
