...
<div class="content">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="stats-mini-card" style="border-left-color: #28a745;">
                <div class="d-flex align-items-center">
                    <div class="icon me-3" style="background: linear-gradient(135deg, #28a745 0%, #1e7e34 100%);">
        ...
        <div class="col-md-3">
            <div class="stats-mini-card" style="border-left-color: #f5576c;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <div class="value">{{ $regionalManagers->sum(function($m) { return $m->regionalScopes->count();
                            }) }}</div>
        ...
        <div class="col-md-3">
            <div class="stats-mini-card" style="border-left-color: #00f2fe;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <div class="value">{{ $regionalManagers->count() > 0 ?
                            number_format($regionalManagers->sum(function($m) { return $m->regionalScopes->count(); }) /
                            $regionalManagers->count(), 1) : 0 }}</div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="manager-avatar-enhanced me-3">
                                                ...
                                                strtoupper(substr($manager->last_name, 0, 1)) }}
                                            </div>
                                            <div>
                                                <div class="fw-bold">{{ $manager->first_name }} {{ $manager->last_name
                                                    }}</div>
                                    ...
                                    <td>
                                        ...
                                        <span class="region-badge-enhanced">
                                            <i class="fa fa-map-pin me-1"></i>{{ $scope->state }}{{ $scope->lga ? ' / '
                                            . $scope->lga : '' }}
                                        </span>
                                        @endforeach
                                        @if($scopes->count() > 3)
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.regional-managers.show', $manager) }}"
                                                ...
                                                title="View Manager Details & Roles">
                                                <i class="fa fa-eye"></i>
                                            </a>
...
<div class="modal fade" id="editManagerRegionsModal" tabindex="-1" aria-labelledby="editManagerRegionsModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="removeRegionalManagerRoleModal" tabindex="-1"
    aria-labelledby="removeRegionalManagerRoleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Are you sure you want to remove the Regional Manager role from <strong
                        id="managerNameToRemoveRole"></strong>?</p>
