...
@section('content')
    <div class="container-fluid py-4">
        ...
        @if($errors->any())
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <i class="fa fa-exclamation-circle me-2"></i> Please check the form for errors.
                <ul class="mb-0 mt-2">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach($regionalMarketers as $marketer)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#assignRegionModal{{ $marketer->user_id }}">
                                                        <i class="fa fa-map-marker-alt"></i> Assign Region
                                                    </button>

                                                    @if($marketer->region)
                                                        <form action="{{ route('regional-marketers.remove', $marketer->user_id) }}"
                                                            method="POST" class="d-inline"
                                                            onsubmit="return confirm('Are you sure you want to remove this regional assignment?');">
                                                            @csrf
                                            ...
                                            <!-- Assign Region Modal -->
                                            <div class="modal fade" id="assignRegionModal{{ $marketer->user_id }}" tabindex="-1"
                                                aria-labelledby="assignRegionModalLabel{{ $marketer->user_id }}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="assignRegionModalLabel{{ $marketer->user_id }}">Assign Region to
                                                                {{ $marketer->first_name }} {{ $marketer->last_name }}</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <form action="{{ route('regional-marketers.assign', $marketer->user_id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <small class="text-muted">Select a state to assign the regional
                                                                        marketer to all cities within that state, or select a
                                                                        specific city.</small>
                                                                </div>
                                                            </div>
                        ...
                        @else
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle me-2"></i> No regional marketers found. To create a regional
                                marketer, assign the "Regional Marketer" role to a user in User Management.
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-light">
                        <h5 class="mb-0">
                            <i class="fa fa-map-marked-alt text-success me-2"></i>
                            Region Overview
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="list-group">
                                        ...
                                        <p class="mb-1">
                                            ...
                                            @else
                                                <span class="text-danger">
                                                    <i class="fa fa-exclamation-circle"></i> No regional marketer assigned
                                                </span>
                                            @endif
                                        </p>
                                    </div>
                            ...
                            @else
                                <div class="alert alert-warning">
                                    <i class="fa fa-exclamation-triangle me-2"></i> No regions with marketers found.
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="card mt-4">
                    <div class="card-header bg-light">
                        <h5 class="mb-0">
                            <i class="fa fa-city text-info me-2"></i>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle me-2"></i> No cities have been assigned regional marketers yet.
                            </div>
                        @endif
                    </div>
                </div>
