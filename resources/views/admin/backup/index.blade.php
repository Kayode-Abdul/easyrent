                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.backup.create') }}">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> Full system backups may take several minutes to complete. Database
                            backups are usually faster.
                        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p>
                                    <span
                                        class="badge badge-{{ $latestBackup['type'] === 'database' ? 'primary' : ($latestBackup['type'] === 'files' ? 'info' : 'success') }}">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('admin.backup.download', $latestBackup['filename']) }}"
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">
                        <i class="nc-icon nc-box"></i> Existing Backups ({{ count($backups) }})
                    </h5>
                </div>
                <div class="card-body">
                    @if(count($backups) > 0)
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge badge-{{ $backup['type'] === 'database' ? 'primary' : ($backup['type'] === 'files' ? 'info' : 'success') }}">
                                            {{ ucfirst($backup['type']) }}
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <br><small class="text-muted">{{
                                            \Carbon\Carbon::parse($backup['created_at'])->diffForHumans() }}</small>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#restoreModal" data-filename="{{ $backup['filename'] }}"
