                    ...
                    <form method="GET" class="row g-3">
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="apartment_id" name="apartment_id">
                                ...
                                <option value="{{ $apartment->apartment_id }}" {{ $apartmentId==$apartment->apartment_id
                                    ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            ...
                            <a href="{{ route('admin.pricing-configuration.audit-trail') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-3">
                            <button class="btn btn-sm btn-outline-info" type="button" data-bs-toggle="collapse"
                                data-bs-target="#rawData{{ $log->id }}" aria-expanded="false">
