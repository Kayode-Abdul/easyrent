            ...
            <div class="apartment-info-card">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="mb-1"><strong>Property:</strong> {{ $apartment->property->property_name ?? 'Unknown
                            Property' }}</p>
                ...
                <div class="config-section">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea
                                class="form-control @error('price_configuration.description') is-invalid @enderror"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number"
                                    class="form-control @error('price_configuration.multiplier') is-invalid @enderror"
                ...
                <div class="accordion" id="helpAccordion">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                            <div class="accordion-body">
                                <strong>Total Amount:</strong> Use when the amount represents the complete rental cost
                                regardless of duration.<br><br>
                                <strong>Monthly Amount:</strong> Use when the amount represents monthly rent that should
                                be multiplied by the rental duration.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                            <div class="accordion-body">
                                <strong>Override Base Amount:</strong> Use a different amount for calculations than the
                                main amount field.<br><br>
                                <strong>Custom Multiplier:</strong> Apply a custom multiplier to the calculation
                                (advanced use only).
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#helpAccordion">
                            <div class="accordion-body">
                                All changes to pricing configurations are logged for audit purposes. You can view the
                                complete audit trail from the main pricing configuration page.
                            </div>
                        </div>
                    </div>
                </div>
