                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="fa fa-heartbeat text-primary"></i> System Health Overview
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="text-center">
                                    <div
                                        class="health-indicator {{ $healthMetrics['calculation_health']['health_status'] }}">
                                        <i class="fa fa-calculator fa-2x"></i>
                                    </div>
                                    <h6 class="mt-2">Calculation Health</h6>
                                    <p class="text-muted">{{ $healthMetrics['calculation_health']['success_rate'] }}%
                                        Success Rate</p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-center">
                                    <div
                                        class="health-indicator {{ $healthMetrics['payment_processing']['health_status'] }}">
                                        <i class="fa fa-credit-card fa-2x"></i>
                                    </div>
                                    <h6 class="mt-2">Payment Processing</h6>
                                    <p class="text-muted">{{ $healthMetrics['payment_processing']['success_rate'] }}%
                                        Success Rate</p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted">{{ $healthMetrics['fraud_detection']['active_alerts'] }} Active
                                        Alerts</p>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="text-center">
                                    <div
                                        class="health-indicator {{ $healthMetrics['system_performance']['health_status'] }}">
                                        <i class="fa fa-tachometer-alt fa-2x"></i>
                                    </div>
                                    <h6 class="mt-2">System Performance</h6>
                                    <p class="text-muted">
                                        {{ $healthMetrics['system_performance']['average_response_time_ms'] }}ms Avg
                                        Response</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="card border-warning">
                        <div class="card-header bg-warning text-dark">
                            <h5 class="card-title mb-0">
                                <i class="fa fa-exclamation-triangle"></i> Active System Alerts
                            </h5>
                        </div>
                        <div class="card-body">
                            @foreach($activeAlerts as $alert)
                                <div
                                    class="alert alert-{{ $alert['severity'] === 'critical' ? 'danger' : ($alert['severity'] === 'error' ? 'warning' : 'info') }} mb-2">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <span
                                            class="badge bg-{{ $alert['severity'] === 'critical' ? 'danger' : ($alert['severity'] === 'error' ? 'warning' : 'info') }}">
            ...
            <div class="col-md-3">
                <div class="card text-white bg-warning">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="card-title">{{ $fraudStats['flagged_users'] + $fraudStats['flagged_referrals'] }}
                                </h4>
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-6">
                                <h4 class="text-secondary">
                                    {{ $chainEffectiveness['total_chains'] - $chainEffectiveness['active_chains'] }}</h4>
                                ...
                                <tbody>
                                    @foreach($chainEffectiveness['top_performing_chains'] as $chain)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-{{ $chain->status === 'active' ? 'success' : 'secondary' }}">
