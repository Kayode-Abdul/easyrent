                        ...
                        <form method="POST" action="{{ route('admin.commission-management.store') }}">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="countrySelector" onchange="loadStates()" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="citySelector" onchange="updateCompositeKey()">
                                        <option value="">Global for State</option>
                                    </select>
                                </div>
                                <input type="hidden" name="region" id="compositeRegionKey"
                                    value="{{ old('region', 'nigeria') }}">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select @error('property_management_status') is-invalid @enderror"
                                        name="property_management_status" required onchange="updateDefaultRates()">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select @error('hierarchy_status') is-invalid @enderror"
                                        name="hierarchy_status" required
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="form-label">Total Commission Rate (%) <span
                                            class="text-danger">*</span></label>
                                    <input type="number"
                                        class="form-control @error('total_commission_rate') is-invalid @enderror"
                                        name="total_commission_rate" value="{{ old('total_commission_rate') }}" step="0.001"
                                        min="0" max="100" required onchange="updateRemainingRate()">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6" id="superMarketerField" style="display: none;">
                                    ...
                                    <input type="number"
                                        ...
                                        name="super_marketer_rate" value="{{ old('super_marketer_rate') }}" step="0.001"
                                        min="0" max="100" onchange="updateRemainingRate()">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('marketer_rate') is-invalid @enderror"
                                        name="marketer_rate" value="{{ old('marketer_rate') }}" step="0.001" min="0"
                                        max="100" required onchange="updateRemainingRate()">
                                    @error('marketer_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number"
                                        ...
                                        name="regional_manager_rate" value="{{ old('regional_manager_rate') }}" step="0.001"
                                        min="0" max="100" onchange="updateRemainingRate()">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('company_rate') is-invalid @enderror"
                                        name="company_rate" value="{{ old('company_rate') }}" step="0.001" min="0" max="100"
                                        required onchange="updateRemainingRate()">
                                    @error('company_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save me-2"></i>Create Commission Rate
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-outline-primary btn-sm w-100 mb-2"
                            onclick="loadTemplate('unmanaged_without_super')">
                            Unmanaged - No Super Marketer
                        </button>
                        <button type="button" class="btn btn-outline-primary btn-sm w-100 mb-2"
                            onclick="loadTemplate('unmanaged_with_super')">
                            Unmanaged - With Super Marketer
                        </button>
                        <button type="button" class="btn btn-outline-info btn-sm w-100 mb-2"
                            onclick="loadTemplate('managed_without_super')">
                            Managed - No Super Marketer
                        </button>
                        <button type="button" class="btn btn-outline-info btn-sm w-100 mb-2"
                            onclick="loadTemplate('managed_with_super')">
                    ...
                    <div class="card-body">
                        <div id="rateValidation">
                            <div class="text-center text-muted">
                                <i class="fa fa-calculator fa-2x mb-2 d-block"></i>
...
@section('scripts')
    <script>
        ...
        function updateCompositeKey() {
            ...
            document.getElementById('compositeRegionKey').value = key;
        }
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            updateRemainingRate();
            if (document.getElementById('countrySelector').value && !document.getElementById('stateSelector').value) {
                loadStates();
            }
        });
    </script>
