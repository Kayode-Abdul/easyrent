                        ...
                        <form method="POST" action="{{ route('admin.commission-management.update', $commissionRate) }}">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ ucfirst(str_replace('_', ' ', $commissionRate->region)) }}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Property Management</label>
                                    <input type="text" class="form-control"
                                        value="{{ ucfirst(str_replace('_', ' ', $commissionRate->property_management_status)) }}"
                                        readonly>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Hierarchy Status</label>
                                    <input type="text" class="form-control"
                                        value="{{ ucfirst(str_replace('_', ' ', $commissionRate->hierarchy_status)) }}"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="number"
                                        ...
                                        step="0.001" min="0" max="100" required onchange="updateRemainingRate()">
                            ...
                            <div class="row mb-3">
                                @if($commissionRate->hierarchy_status === 'with_super_marketer')
                                    <div class="col-md-6">
                                        ...
                                        <input type="number"
                                            ...
                                            step="0.001" min="0" max="100" onchange="updateRemainingRate()">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('marketer_rate') is-invalid @enderror"
                                        name="marketer_rate"
                                        value="{{ old('marketer_rate', $commissionRate->marketer_rate) }}" step="0.001"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('company_rate') is-invalid @enderror"
                                        name="company_rate" value="{{ old('company_rate', $commissionRate->company_rate) }}"
                                        step="0.001" min="0" max="100" required onchange="updateRemainingRate()">
                                    @error('company_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save me-2"></i>Update Commission Rate
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="sampleRent" value="100000" min="0"
