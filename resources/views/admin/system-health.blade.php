                    ...
                    <div class="row">
                        <div class="col-5 col-md-4">
                            <div class="icon-big text-center icon-warning">
                                <i
                                    class="nc-icon nc-tile-56 text-{{ $health['database']['status'] === 'healthy' ? 'success' : 'danger' }}"></i>
                            </div>
                        </div>
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p
                                    class="card-title text-{{ $health['database']['status'] === 'healthy' ? 'success' : 'danger' }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-5 col-md-4">
                            <div class="icon-big text-center icon-warning">
                                <i
                                    class="nc-icon nc-box text-{{ $health['storage']['status'] === 'healthy' ? 'success' : ($health['storage']['status'] === 'warning' ? 'warning' : 'danger') }}"></i>
                            </div>
                        </div>
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-5 col-md-4">
                            <div class="icon-big text-center icon-warning">
                                <i
                                    class="nc-icon nc-refresh-69 text-{{ $health['cache']['status'] === 'healthy' ? 'success' : 'danger' }}"></i>
                            </div>
                        </div>
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p
                                    class="card-title text-{{ $health['cache']['status'] === 'healthy' ? 'success' : 'danger' }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-5 col-md-4">
                            <div class="icon-big text-center icon-warning">
                                <i
                                    class="nc-icon nc-time-alarm text-{{ $health['queue']['status'] === 'healthy' ? 'success' : 'danger' }}"></i>
                            </div>
                        </div>
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p
                                    class="card-title text-{{ $health['queue']['status'] === 'healthy' ? 'success' : 'danger' }}">
