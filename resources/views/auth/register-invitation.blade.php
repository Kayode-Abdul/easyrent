                    ...
                    <div class="auth-body">
                        ...
                        <div class="invitation-context">
                            ...
                            <div class="alert alert-success mb-0">
                                ...
                                <small><strong>Special Offer:</strong> Create your account now and complete your apartment application in one seamless process!</small>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="auth-links">
                            ...
                            <a href="{{ route('login') }}{{ request('token') ? '?token=' . request('token') : '' }}" class="ms-1">
