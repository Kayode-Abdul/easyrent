    ...
    <div class="container-fluid mb-3">
        <div class="d-flex justify-content-end align-items-center">
            <div>
                ...
                <span class="switch-label">Property Manager Dashboard</span>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-footer">
                    <hr>
                    <div class="stats">
                        <i class="fa fa-users"></i> {{ $stats['occupied_apartments'] }}/{{ $stats['total_apartments'] }}
                        Occupied
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $occupancyRate = $totalApartments > 0 ? round(($occupiedApartments / $totalApartments) *
                                100, 1) : 0;
                                @endphp
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        @if($property->owner)
                                        <div>
                                            <strong>{{ $property->owner->first_name }} {{ $property->owner->last_name
                                                }}</strong><br>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted">{{ $occupiedApartments }}/{{ $totalApartments }}
                                            occupied</small>
                                    </td>
                                    <td>
                                        <div class="btn-group">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="{{ route('property-manager.payments') }}"
    ...
    $(function () {
        ...
        $('#propertyManagerDashboardSwitch').on('change', function () {
            ...
            $.ajax({
                ...
                error: function () {
                    $switch.prop('disabled', false);
                    alert('Error switching PM mode. Please try again.');
                }
            });
        });
    });
