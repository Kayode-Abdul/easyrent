                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <span class="badge badge-primary">{{ $types[$property->prop_type] ?? 'Other'
                                            }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        @if($property->status)
                                        <span
                                            class="badge badge-{{ $property->status === 'approved' ? 'success' : ($property->status === 'pending' ? 'warning' : 'danger') }}">
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td>{{ $property->created_at ? $property->created_at->format('M d, Y') : 'N/A' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td><strong>Approved:</strong></td>
                                    <td>{{ $property->approved_at ? $property->approved_at->format('M d, Y') : 'Not
                                        approved' }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Total Apartments:</strong></td>
                                    <td><span class="badge badge-info">{{ $propertyStats['total_apartments'] }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td><strong>Occupied:</strong></td>
                                    <td><span class="badge badge-success">{{ $propertyStats['occupied_apartments']
                                            }}</span></td>
                                </tr>
                                <tr>
                                    <td><strong>Vacant:</strong></td>
                                    <td><span class="badge badge-warning">{{ $propertyStats['vacant_apartments']
                                            }}</span></td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <x-currency-carousel :currencies="$propertyStats['monthly_revenue'] ?? []" :decimals="0" id="pm-monthly-revenue" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <x-currency-carousel :currencies="$propertyStats['total_revenue'] ?? []" :decimals="0" id="pm-total-revenue" />
                            </div>
                        </div>
                    </div>
                </div>
