            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                    ...
                    <div class="card-footer">
                        <hr>
                        <div class="stats">
                            <i class="fa fa-home"></i> {{ $occupiedApartments }} Occupied, {{ $vacantApartments }}
                            Vacant
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>New user registered: {{ $recentUser->first_name }} {{ $recentUser->last_name
                                            }}</td>
                                    ...
                                    <tr>
                                        <td>{{ $message->is_read ? 'Read' : 'New' }} message from {{
                                            $message->sender->first_name ?? 'Unknown' }}</td>
