...
@section('content')
                        ...
                        <form method="GET" action="{{ route('super-marketer.referred-marketers') }}" class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="region" name="region">
                                    ...
                                    <option value="Ibadan" {{ request('region') === 'Ibadan' ? 'selected' : '' }}>Ibadan
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="card-body">
                        @if($marketers->count() > 0)
                                        ...
                                        @foreach($marketers as $marketer)
                                                                            ...
                                                                            <div class="me-3">
                                                                                @if($marketer->photo)
                                                                                    <img src="{{ asset('storage/' . $marketer->photo) }}"
                                                                                        alt="{{ $marketer->first_name }}" class="rounded-circle" width="40"
                                                                                        height="40">
                                                                                @else
                                            ...
                                            ($marketer->marketer_status === 'pending' ? 'warning' : 'danger') 
                                                                    ...
                                                                    <td>
                                                                        <div class="small">
                                                                            <div>
                                                                                <strong>{{ $marketer->performance_metrics['total_referrals'] }}</strong>
                                                                                referrals</div>
                                                                            <div class="text-success">
                                                                                {{ $marketer->performance_metrics['conversion_rate'] }}% conversion
                                                                            </div>
                                                                            <div class="text-muted">
                                                                                {{ $marketer->performance_metrics['this_month_referrals'] }} this month
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="small">
                                                                            <div class="font-weight-bold">
                                                                                {{ format_money($marketer->performance_metrics['total_commission']) }}
                                                                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <div class="text-muted">
                                    Showing {{ $marketers->firstItem() }} to {{ $marketers->lastItem() }} of
                                    {{ $marketers->total() }} results
                                </div>
                                <div>
    ...
    <div class="modal fade" id="marketerDetailsModal" tabindex="-1" aria-labelledby="marketerDetailsModalLabel"
        aria-hidden="true">
