                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="text-muted mb-0">Detailed analysis of your commission performance and network
                                    earnings</p>
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('super-marketer.commission-analytics') }}" class="row g-3">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                ...
                                <a href="{{ route('super-marketer.commission-analytics') }}"
                            ...
                            <div class="col-md-3 d-flex align-items-end justify-content-end">
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-outline-info btn-sm"
                                        onclick="setDateRange('7days')">7 Days</button>
                                    <button type="button" class="btn btn-outline-info btn-sm"
                                        onclick="setDateRange('30days')">30 Days</button>
                                    <button type="button" class="btn btn-outline-info btn-sm"
                                        onclick="setDateRange('90days')">90 Days</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div
                                    class="text-xs {{ $comparison['growth_percentage'] >= 0 ? 'text-success' : 'text-danger' }}">
                                    <i
                                        class="fa fa-{{ $comparison['growth_percentage'] >= 0 ? 'arrow-up' : 'arrow-down' }}"></i>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            <span class="mr-2">
                                <i class="fa fa-circle text-success"></i> Your Commission
                            </span>
                            <span class="mr-2">
                                <i class="fa fa-circle text-primary"></i> Network Commission
                            </span>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @foreach($commissionTrends as $index => $trend)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ rand(1, 10) }}</td>
                                            <!-- Placeholder - would be calculated from actual data -->
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
