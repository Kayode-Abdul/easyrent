    ...
    <div class="content">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="text-muted mb-0">Welcome back, {{ $superMarketer->first_name }}! Manage your
                                    marketer network and track performance.</p>
                            </div>
                            <div>
                                <span class="badge bg-warning fs-6">
                                    <i class="fa fa-star"></i> Super Marketer
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                :subicon="'fa fa-' . ($stats['commission_growth'] >= 0 ? 'arrow-up' : 'arrow-down')"
                color="warning"
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                ...
                                <a class="dropdown-item" href="{{ route('super-marketer.commission-analytics') }}">View
                            ...
                            <form id="generateLinkForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="notes" name="notes" rows="2"
                                        placeholder="Campaign notes..."></textarea>
                                </div>
                        ...
                        @if($topPerformers->count() > 0)
                            @foreach($topPerformers as $marketer)
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar me-3">
                                        ...
                                        @else
                                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center"
                                                ...
                                                <span
                                                    class="text-white font-weight-bold">{{ substr($marketer->first_name, 0, 1) }}</span>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="text-end">
                                        <span
                                            class="badge bg-{{ $marketer->marketer_status === 'active' ? 'success' : 'warning' }}">
                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    <h5 class="text-success">
                                        {{ format_money($commissionBreakdown['super_marketer_total']) }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        <small class="text-muted">
                            Share this link with potential marketers to grow your network and earn commissions from their
                            referrals.
                        </small>
                    </div>
                </div>
